...
% affiliations
    ...
    \\
    \IEEEauthorblockA{(University of Auckland):\\ Department of Electrical, Computer, and Software Engineering, Auckland, New Zealand}
...
%    \end{algorithmic}
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item repeat from step \ref{pt:PRI0}: % todo remove the goto
        \end{enumerate}
    \end{enumerate}
